...
const initApp = function () {
    const jsonFile = "./assets/js/data.json";
...
const appendDataToDiv = async function (products) {
    const listProductEl = document.getElementById('ProductList');
...
const updateCartListDisplay = function (products) {
    ...
    if (cartList.length === 0) {
        ...
        cartListEl.innerHTML = `<div class="empty_cart" style="display: flex;">
            <img src="./assets/images/illustration-empty-cart.svg" alt="">
            <span>Your added items will appear here.</span>
          </div>`;
        quantityCount.innerText = '(0)'; // Update quantity to 0
